...
class MovieGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Movie entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "originalTitle":"SAMPLE_TEXT", "overview":"SAMPLE_TEXT", "releaseDate":"2020-01-01T00:00:00.000Z", "runtime":"0", "voteRating":null, "voteCount":"0", "homepage":"SAMPLE_TEXT", "budget":null, "revenue":null, "tmdbId":"0"}""")).asJSON
            .check(status.is(201))
